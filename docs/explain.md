...
---
2. 어플리케이션 log - host /logs 디렉터리에 적재</br>
- 로그 설정: [logback-spring.xml](https://github.com/rayshoo/spring-petclinic-data-jdbc/blob/master/was/src/main/resources/logback-spring.xml)
...
---
3. 정상 작동 api 구현, 10초마다 체크</br>
- 정상 작동 api 구현: [health probe enable](https://github.com/rayshoo/spring-petclinic-data-jdbc/blob/cd433335fb563ee4cbfa441a8e9b48cd621876e8/was/src/main/resources/application.yaml#L39)
...
---
4. 3번 연속 체크 실패시, 어플리케이션 restart</br>
...
---
5. 종료 시 30초 이내 프로세스 종료 안될 시, SIGKILL 강제 종료</br>
- server: [appication.yaml](https://github.com/rayshoo/spring-petclinic-data-jdbc/blob/cd433335fb563ee4cbfa441a8e9b48cd621876e8/was/src/main/resources/application.yaml#L7)
...
---
7. 어플리케이션 프로세스 uid:1000으로 실행</br>
...
---
8. DB kubernetes 실행, 재 실행시 변경된 데이터 유실 방지</br>
...
---
9. 어플리케이션 - DB cluster domain 통신</br>
...
---
10. nginx-ingress-controller를 통해 어플리케이션 접속</br>
...
---
11. namespace default 사용</br>
- manifests 모든 리소스에 default 네임스페이스 명시적으로 작성.

---
12. README.md 파일 실행 방법 기술</br>
- [README.md](../README.md)